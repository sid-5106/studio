...
import { RiskyUserDetail, TopPolicySummary, NonRiskyUserDetail } from '@/app/actions';
...
import { NonRiskyUsersTable } from './non-risky-users-table';
...
interface RiskyUsersViewProps {
    ...
    nonRiskyUsersDetails: NonRiskyUserDetail[];
}
          ...
          <div>
            <Tooltip>
              <TooltipTrigger asChild>
                <Card>
                  <CardHeader>
                    <CardTitle>Non-Risky Users</CardTitle>
                    <CardDescription>Users with alerts who are not classified as risky.</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <NonRiskyUsersTable users={nonRiskyUsersDetails} />
                  </CardContent>
                </Card>
              </TooltipTrigger>
              <TooltipContent>
                <p>This table lists users who have triggered alerts but are not currently in the risky users list.</p>
              </TooltipContent>
            </Tooltip>
          </div>
          <div>
